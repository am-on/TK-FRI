...
class PrijateljPrimerjajPoImenu implements java.util.Comparator<Prijatelj>
{
    @Override
...
class PrijateljPrimerjajPoTelSt implements java.util.Comparator<Prijatelj>
{
    @Override
    public int compare(Prijatelj o1, Prijatelj o2)
    {
...
public class Prijatelj implements java.io.Serializable
{
    protected String ime;
    protected String priimek;
    protected String telefonskaStevilka;
